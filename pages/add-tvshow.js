        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '18px' }}>
              Masukkan TMDB ID untuk menambahkan TV Show
            </p>
          </div>
          <div style={{
            ...
            <form onSubmit={handleSubmit} style={{ marginBottom: '24px' }}>
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: 'gold' }}>
                  TMDB ID
                </label>
          ...
          {preview && (
            <div className="fade-in" style={{
              ...
              <h3 style={{ marginBottom: '20px', textAlign: 'center', color: '#fff' }}>Preview TV Show</h3>
              <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
                ...
                />
                <div style={{ flex: '1' }}>
                  <h2 style={{ marginBottom: '12px', color: '#fff' }}>{preview.name}</h2>
